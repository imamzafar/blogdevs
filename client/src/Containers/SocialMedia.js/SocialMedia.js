        ...
        <div className="footer-icon-sidebar">
            <ul className="navbar-nav">
                <li className="nav-item inline-block">
                    <a href="https://github.com/imamzafar" aria-label="Github" className="nav-link text-github"><i
                ...
                <li className="nav-item inline-block"><a href="https://www.linkedin.com/in/zafar-imam-83308792/" aria-label="LinkedIn" className="nav-link"><i className="fa fa-linkedin"
                ></i></a>
                </li>
            </ul>
        </div>
